...
function main(){
    ...
    fetchChat.on("child_added", function (snapshot) {
      const messages = snapshot.val();
        const msg = "<div class=\"mentorCon\"><img id=\""+messages.id+"\" class=\"menimg\" height=\"120px\" width=\"120px\" src=\"./src/profile.png\"><div class=\"mentors\"> Name: "+ messages.name +"<br>Email: "+messages.email+"<br>Department: "+messages.depart+"<br>Designation: "+messages.desig+"<br>Mobile: "+messages.mobile+" </div></div>";
