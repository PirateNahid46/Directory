const firebaseConfig = {
 ...
 function load(cn){
  ...
  fetchChat.once("value").then( function (snapshot) {
    ...
    document.getElementById("misc").innerHTML ="<br>"+ snapshot.child("flName").val() + "<br>Birthday:  "+ snapshot.child("bdate").val() + "<br> Blood Group: "+ snapshot.child("bgroup").val() + "<br> Misc. "+ snapshot.child("misc").val();
